...
function gotoPage( pageNum ){
	if( typeof(pageCount) == "undefined" ){
		alert("designate page number（define pageCount）！");
		return;
	}	
	...
	if( pageNum == "" || isNaN(pageNum) ){
		alert("please type in page number！from 1-" + pageCount);
 ...
 */
function delConfirm(){
	return window.confirm("delete confirm");
}
