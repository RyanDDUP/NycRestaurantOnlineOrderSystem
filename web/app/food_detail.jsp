...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/app/${pageContext.request.contextPath}/app/style/css/index_1.css" />
		...
		<div id="menu1">
			...
			<div class="menu3">
				...
				<div class="menu3_right">
					<p>name:${requestScope.food.foodName}</p>

					<p>price:&nbsp;&nbsp;&dollar;&nbsp;${requestScope.food.price}</p>
					<p>vip price:&nbsp;&nbsp;&dollar;&nbsp;${requestScope.food.mprice}</p>

					<p align="left">description:<font color="#00008b">${requestScope.food.description}</font></p>

				</div>
			</div>
			<div class="menu4">
				
				<a href="${pageContext.request.contextPath}/order?method=addToCart&foodId=${requestScope.food.id}" style="background:url(${pageContext.request.contextPath}/app/style/images/img/order_left_corner_bg.png);">add to cart</a>
				<a href="#" onclick="javascript:history.go(-1);" style="background:url(${pageContext.request.contextPath}/app/style/images/img/order_right_corner_bg.png);">go back</a>
			</div>
		</div>
		...
		<div id="dish_class">
			<div id="dish_top">
				...
				<li class="dish_num"></li>
					<li>
						<a href="${pageContext.request.contextPath}/app/orderlist.jsp">
