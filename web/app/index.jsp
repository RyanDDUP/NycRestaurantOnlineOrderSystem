		...
		<div id="index_center">
			...
			<div id="center_bottom">
				<ul style=" display:inline-table">
					<c:choose>
						<c:when test="${not empty requestScope.available}">
							<c:forEach items="${requestScope.available}" var="table">
								<li>
									<a href="${pageContext.request.contextPath}/food?method=menu&tableId=${table.id}">
										${table.tableName}&nbsp;
									</a>
								</li>
